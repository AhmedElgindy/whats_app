...
class StatusScreen extends StatelessWidget {
  ...
  Widget status(context, index) {
    return WhatsCubit.get(context).status[index].uId ==
            WhatsCubit.get(context).userModel!.uId
        ? InkWell(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => StatusDetails(
                          ...
                          imageStatus: WhatsCubit.get(context)
                              .status[index]
                              .statusImage!,
            ...
            child: WhatsCubit.get(context).status[index].uId !=
                    WhatsCubit.get(context).userModel!.uId
                ? Row(
                    children: [
                      CircleAvatar(
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) => StatusDetails(
                    ...
                    image: WhatsCubit.get(context).status[index].image!,
                    imageStatus:
                        WhatsCubit.get(context).status[index].statusImage!,
                    text: WhatsCubit.get(context).status[index].text!,
